# AMI Backup Automation via AWS Lambda
# This code is referred from with slight changes: https://gist.github.com/bkozora/724e01903a9ad481d21e
#
# This script will search for all instances having a tag with key "Backup" 
# on it and are in "running" state. After searching, it loop through each instance
# and creates an AMI of it. Also, it will look for a "Retention" tag key which
